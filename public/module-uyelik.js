...
const PALETTE_OPTIONS = [
  ...
  { key: 'aytasi', label: 'Ay Taşı', colors: ['#EDEFF6', '#5C6FA3', '#B99B6B'] },
  { key: 'kehribar', label: 'Kehribar', colors: ['#FBF1DD', '#C2660C', '#6B4423'] },
  { key: 'yesim', label: 'Yeşim', colors: ['#E7EFE9', '#3C8C6E', '#6E8C7A'] },
];
