...
export async function GET() {
  ...
  const [clientCount, openCases, closedCases, canSeeGelirGider] = await Promise.all([
    prisma.client.count({ where: { workspaceId: ws.workspaceId } }),
  ...
  result.muvekkil = { total: clientCount };
